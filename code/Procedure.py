...
def BPR_train_original(dataset, recommend_model, loss_class, bpr_size, epoch, neg_k=1, w=None):
    ...
    for (batch_i,
        ...
        # if world.tensorboard:
            # w.add_scalar(f'BPRLoss/BPR',\ 
            #     cri, epoch * int(len(users) / world.config['bpr_batch_size']) + batch_i)
